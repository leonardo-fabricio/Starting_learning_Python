...
from tkinter import *
import random #importando uma class possivelmente para gerar aleatorios
import time #importando uma classe de tempo

level = int(input("Qual nível você gostaria de jogar? 1/2/3/4/5 \n")) #acredito que converte o valor passado para inteiro
length = 500/level 


root = Tk() #recebe uma tupla vazia
